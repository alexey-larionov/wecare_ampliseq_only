...
# s01_calculate_joined_PCs.sh
# Started: Alexey Larionov, 13Jul2019
# Last updated: Alexey Larionov, 30Sep2019

# Use:
# ./s01_calculate_joined_PCs.sh > s01_calculate_joined_PCs.log

# Calculate PCs for joined 1kgp-ampliseq dataset (excluding rare variants and variants in LD)

# Stop at runtime errors
set -e

# Start message
echo "Calculate PCs for joined 1kgp-ampliseq dataset (excluding rare variants and variants in LD)"
date
echo ""
...
data_folder="${base_folder}/s05_calculate_joined_1kgp_ampliseq_PCs/data"
rm -fr "${data_folder}"
mkdir -p "${data_folder}"

source_vcf="${base_folder}/s04_merge_1kgp_and_wecare_genotypes/data/s01_joined_1kgp_ampliseq_biallelic_snps_2009_3019.vcf.gz"
...
initial_plink_dataset="${plink_dataset_folder}/ampliseq_1kg_2009_3019"
...
common_variants="${output_data_folder}/ampliseq_1kgp_non_rare_902_3019"
...
LD_pruned_datset="${output_data_folder}/ampliseq_1kgp_non_rare_not_in_LD_622_3019"
...
pca_results="${pca_results_folder}/ampliseq_1kg_622_3019_100PCs"
...
echo "Calculated 100 top PCs for joined 1kgp and ampliseq dataset using 622 non-rare variants not in LD"
echo ""
